...
enum DefaultExerciseDatabase {
    static var exercises: [ExerciseItem] {
        [
            ...
            // Pull
            ExerciseItem(name: "Assisted Muscle-Ups", category: .pull, numberOfSets: 3, numberOfReps: 2, restSeconds: 60),
            ...
            ExerciseItem(name: "Dead Hangs", category: .pull, numberOfSets: 3, numberOfReps: 10, restSeconds: 60),
            ...
            // Handstand
            ExerciseItem(name: "Handstand Push-Ups", category: .handstand, numberOfSets: 3, numberOfReps: 1, restSeconds: 30),
