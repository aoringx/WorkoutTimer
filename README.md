...
- Assign each exercise one Planche, Push, Pull, Legs, Handstand, L-sit, Core, Freeze, Power, Cardio, or Popping type, with duplicate names supported across different types.
